...
;(function(window, factory) {
    ...
    jet.extend(jeDatePick.prototype,{
        ...
        dateTemplate : function() {
            ...
            //循环年的模板
            var yaerHtml = '<table class="yeartable year{%= i==0 ? "left":"right"%}" style="display:{%=year ? "block":"none"%};"><tbody style="display:inline-table;width:100%"><tr>'+
            ...
            //循环月的模板
            var monthHtml = '<table class="monthtable month{%= i==0 ? "left":"right"%}" style="display:{%=month ? "block":"none"%};"><tbody style="display:inline-table;width:100%"><tr>'+
            ...
            '{% for(var w=0;w<lang.weeks.length;w++){ %} <th>{%=lang.weeks[w]%}</th> {% } %}</tr></thead><tbody style="display:inline-table;width:100%">'+
